...
public abstract class Configuration<C> where C : class, new() {
    ...
    public static C Load() {
        if (instance == null) {
            ...
            try {
                ...
                Debug.Log("[ScaleUI] Configuration:Load -> Exception: " + e.Message);
            }
        }
    ...
    public static void Save() {
        ...
        try {
            ...
            Debug.Log("[ScaleUI] Configuration:Save -> Exception: " + e.Message);
        }
    }
    ...
    private static string GetConfigPath() {
        if (typeof(C).GetCustomAttributes(typeof(ConfigurationPathAttribute), true)
            ...
            Debug.Log("[ScaleUI] Configuration:GetConfigPath -> ConfigurationPath attribute missing in " + typeof(C).Name);
